...
<Card.Root class="overflow-hidden brutal-card bg-card">
  ...
  <Card.Content class="space-y-4 pt-4">
    ...
    {:else}
      {#each invoicesNeedingAttention as invoice}
        <div
        ...
        >
          <div class="flex items-center gap-3">
            <div class="shrink-0">
              <div
                class="flex h-10 w-10 items-center justify-center rounded-xl border border-brutal {invoice.status === 'overdue' ? 'bg-[#ff8a8a]/20' : 'bg-[#fde047]/20'}"
              >
          ...
          <div class="flex items-center gap-2">
            <div class="text-right">
              <div class="font-space text-sm font-extrabold {invoice.status === 'overdue' ? 'text-red-600 dark:text-red-500' : ''}">
